...
| 90000008 | 车企后台 | OP/Key Sharing | ERROR_CODE_VEHICLE_RELATIONSHIP_UNBIND - 车辆关系已解绑（Owner Pairing和First Friend场景均可能触发） |
...
| TBOX DNS解析失败 | 车企后台 | Phase 0 | TBOX无法解析后台域名(xmart.uat.cn-vwa.volkswagen-cea.com)，配置获取阶段失败 |
| ICS SDK permission check | 手机端 | Phase 1 | 后台返回data:false，SDK判定用户无该VIN的钥匙权限，无法进入NFC配对 |
