...
| Ticket | 问题端 | 附件数 | 提取数 | 日志类型 | 章节 | 大小 | 质量 | 根因 |
|--------|:------:|-------:|-------:|---------|:----:|-----:|:----:|------|
| VCTCEM-6549 | 车端 | 15 | 4 | .vw+.log+.asc+.ubin | 7 | 4.2KB | OK | 车端 - NFC ECP cccop=2只读模式，sw=0x6400，Phase2失败 | |
| VCTCEM-7900 | 车端 | 3 | 0 | 截图+xlsx | 7 | 2.8KB | 无日志 | 车端 - NFC天线距离不满足MFi要求(≥4cm)，硬件设计问题 | |
| VCTCEM-9461 | 车端 | 3 | 0 | csv+html | 7 | 2.5KB | 无日志 | 车端 - NFC使用旧版本(007)，VR36/013版本才支持CCC spec | |
